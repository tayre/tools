...
print_help() {
	...
	printf "%-30s %s\n" "-b --bayer-scale" "If dither=bayer select the pattern size in the range of 0 - 5. Lower values tend to produce fewer artifacts but larger images. (Default: $bayer_scale)"
